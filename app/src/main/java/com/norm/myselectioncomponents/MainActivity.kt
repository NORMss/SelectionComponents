package com.norm.myselectioncomponents
...
import com.norm.myselectioncomponents.ui.theme.MySelectionComponentsTheme

class MainActivity : ComponentActivity() {
    override fun onCreate(savedInstanceState: Bundle?) {
        super.onCreate(savedInstanceState)
        setContent {
            MySelectionComponentsTheme {
                Surface(
                    modifier = Modifier
                        .fillMaxSize(),
